    ...
    <div className="flex flex-col items-center justify-center min-h-[70vh] text-center p-4">
      {success ? (
        <>
          ...
          <h2 className="text-[32px] font-medium">Booking Confirmed</h2>
          {booking ? (
            <p className="mt-4 text-[#656565] font-normal text-xl">
              Ref ID: <span className="font-normal text-xl">{booking._id}</span>
            </p>
          ) : null}
          <Link
            to="/"
            className="mt-10 bg-[#E3E3E3] text-[#656565] px-4 py-2 rounded-[4px]"
          >
            Back to Home
          </Link>
        </>
        ...
        <>
          <h2 className="text-3xl font-bold text-red-600">Booking Failed</h2>
          <p className="mt-2 text-gray-600">
            Something went wrong. Please try again.
          </p>
          <Link
            to="/"
            className="mt-6 bg-gray-200 text-gray-700 px-4 py-2 rounded-md"
          >
            Back to Home
          </Link>
        </>
